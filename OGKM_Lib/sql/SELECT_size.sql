...
SELECT products.id,category, IFNULL(IFNULL(product_merch.typecolorname,product_surrounding_sizes.typecolorname), '') as the_typecolor_name,
    IFNULL(size, '') as size_name,	
    IFNULL(IFNULL(product_surrounding_sizes.stock,product_merch.stock),products.stock) as real_time_stock
