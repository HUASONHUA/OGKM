...
//	            return sum % 10 == 0;
	...
	public void setEmail(String email) {
	        Boolean emailTF = Boolean.valueOf(email.matches(emailregex));
	        if(emailTF.booleanValue()){
	            this.email = email;
	           // System.out.println("email正確");
	        } else{
	            emailTF = Boolean.valueOf(email.matches(emailregex1));
	            if(emailTF.booleanValue()){
	                this.email = email;
	               // System.out.println("email正確");
	            } else{
	...
	public void setPassword(String password) {
        ...
        Boolean passwordTF = Boolean.valueOf(password.matches(passwordregex));
        if(passwordTF.booleanValue()){
